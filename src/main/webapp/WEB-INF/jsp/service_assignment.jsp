...
$(function(){
	$('#tt').datagrid({
	    url:'${ctx}/customerservice/getAllServiceByStatus.action',
	    toolbar:'#tb',
	    columns:[[
	...
	function openUpdateDialog() {
		$("#dialogId").dialog({
			...
			buttons : [ {
				...
				iconCls : "icon-ok",
				handler : function() {
					var url = "${ctx}/customerservice/doAssignment.action";
					operatingData(url);
				}
			}, {
				text : "关闭",
...
<body>
	...
	<div id="tb" style="padding:3px">
		<div>
			<a href="javascript:doAssignment()" class="easyui-linkbutton" iconCls="icon-add" plain="true">分配</a>
		</div>
	</div>
